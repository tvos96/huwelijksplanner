...
export const defaultData = ({ partnerA = "", partnerB = "" } = {}) => ({
  ...
  budget: {
    total: 0, saved: 0,
    items: [
      { id: uid(), label: "Locatie", est: 0, paid: 0 },
      { id: uid(), label: "Catering & drank", est: 0, paid: 0 },
      { id: uid(), label: "Kleding", est: 0, paid: 0 },
      { id: uid(), label: "Fotografie & video", est: 0, paid: 0 },
      { id: uid(), label: "Bloemen & decoratie", est: 0, paid: 0 },
      { id: uid(), label: "Muziek / DJ", est: 0, paid: 0 },
      { id: uid(), label: "Ringen", est: 0, paid: 0 },
      { id: uid(), label: "Uitnodigingen & drukwerk", est: 0, paid: 0 },
    ],
  },
  tasks: [
    ...
    { id: uid(), label: "Gastenlijst afronden", done: false },
    ...
    <div className="min-h-screen bg-canvas pb-28">
      ...
      <div className="mx-auto max-w-[780px] px-4 pt-7">
        ...
        <div className="mt-8 text-center text-xs text-muted">
          Gemaakt met liefde · <a className="underline" href="/privacy.html">privacyverklaring</a> · <button className="underline" onClick={() => setResetOpen(true)}>opnieuw beginnen</button>
        </div>
      </div>
